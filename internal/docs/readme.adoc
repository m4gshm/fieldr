...
* link:#constructor-with-optional-arguments-usage-example[constructor-opt] - generates a function to create a struct instance with optional initialization.
* link:#constructor-that-required-all-field-values-usage-example[constructor] - generates a function to create a struct instance with full initialization.
...
[source,go]
----
include::../examples/usage/constructor-opt/entity.go[]
----
...
[source,go]
----
include::../examples/usage/constructor-full/entity.go[]
----
...
[source,go]
----
include::../examples/usage/constructor/entity_fieldr.go[]
----
