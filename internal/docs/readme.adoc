...
* stringify-enum - generates method and functions for converting an enum const to a string and vice versa.
...
[source,go]
----
include::../examples/usage/stringify_enum/enum.go[]
----
...
[source,go]
----
include::../examples/usage/stringify_enum/enum_fieldr.go[]
----
