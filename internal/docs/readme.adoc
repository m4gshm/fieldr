...
* link:#constructors-with-fill-and-optional-arguments-example[constructor] - generates functions that create a structure instance with full or partial initialization.
...
=== constructors with fill and optional arguments example

source `entity.go`

[source,go]
----
include::../examples/usage/constructor/entity.go[]
----
