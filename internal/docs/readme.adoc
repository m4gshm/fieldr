...
* enrich-const-type - extends a constants type by 'get name' method, 'enum all values' function and `get the constant by a value of the underlying type` function.
