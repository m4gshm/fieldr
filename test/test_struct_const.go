// Code generated by 'const -type TestStruct -wrap -export -output test_struct_const.go'; DO NOT EDIT.
...
var (
	...
	testStruct_Field_Tag_Value = map[TestStructField]map[TestStructTag]TestStructTagValue{
		...
		TestStruct_Name:   map[TestStructTag]TestStructTagValue{TestStruct_json: TestStruct_json_Name, TestStruct_db: TestStruct_db_Name},
