...
func TestBuilderEmpty(t *testing.T) {
	...
	expected := &Entity[int32]{BaseEntity: &BaseEntity[int32]{RefCodeAwareEntity: &RefCodeAwareEntity{CodeAwareEntity: &CodeAwareEntity{}}}}
...
func TestBuilderFields(t *testing.T) {
	...
	expected := Entity[int32]{BaseEntity: &BaseEntity[int32]{ID: 2, RefCodeAwareEntity: &RefCodeAwareEntity{CodeAwareEntity: &CodeAwareEntity{}}}, Name: "1", Surname: "3", Embedded: EmbeddedEntity{Metadata: "meta"}}
	assert.Equal(t, expected, actual)
}
