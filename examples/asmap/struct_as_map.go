...
func (v Struct) AsMap() map[StructField]interface {
	...
	}{StructFieldID: v.ID, StructFieldTS: v.TS, StructFieldName: v.Name, StructFieldSurname: v.Surname, StructFieldNoTag: v.NoTag, StructFieldIgnoredInTagMap: v.IgnoredInTagMap, StructFieldAddress: v.Address.AsMap(), StructFieldFlatNoPrefixCardNum: v.FlatNoPrefix.CardNum, StructFieldFlatNoPrefixBank: v.FlatNoPrefix.Bank, StructFieldFlatPrefixCardNum: v.FlatPrefix.CardNum, StructFieldFlatPrefixBank: v.FlatPrefix.Bank}
}
