// Code generated by 'fieldr -type Entity -output entity_fields.go -wrap -Strings -TagValuesMap -GetFieldValuesByTag'; DO NOT EDIT.
...
var (
	entity_TagValues = map[entityTag]entityTagValues{
		entityTag_db: entityTagValues{entityTagValue_db_ID, entityTagValue_db_Name, entityTagValue_db_Surname},
	}
)
