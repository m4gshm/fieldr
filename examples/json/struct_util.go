// Code generated by 'fieldr -type Struct -export -output struct_util.go -Fields -FieldTagValueMap -GetFieldValue'; DO NOT EDIT.
...
var (
	struct_Fields = []string{StructField_ID, StructField_Name, StructField_Surname, StructField_NoJson, StructField_NoTag}
