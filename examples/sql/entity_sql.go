// Code generated by 'fieldr -type Entity -src ../util/const_template.go -output entity_sql.go -const _upsert:sql_Upsert -const _selectByID:sql_selectByID -const _deleteByID:sql_deleteByID -const _updateByID -const _insert -const _pk'; DO NOT EDIT.
